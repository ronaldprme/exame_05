...
ASpell::ASpell(std::string const &name, std::string const &effects){this->name = name; this->effects = effects;}
...
void ASpell::launch(ATarget const &target_ref)const{target_ref.getHitBySpell(*this);}
